...
/**
 * Used to create a new Iterator to traverse FreezeTracker in the forward direction
 */
 ...
 */
  ...
  /**
   * Used to to go to the next element in the Linked List
   * 
  ...
  public LakeRecord next() throws NoSuchElementException {
    ...
    LakeRecord nextRecord = current.getLakeRecord();
