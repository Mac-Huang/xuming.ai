...
main(void)
{
  ...
  11:	68 c8 07 00 00       	push   $0x7c8
  16:	6a 01                	push   $0x1
  18:	e8 83 04 00 00       	call   4a0 <printf>
  
  sleep(1);
  1d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  24:	e8 aa 03 00 00       	call   3d3 <sleep>
  printf(1, "Parent working\n");
  29:	58                   	pop    %eax
  2a:	5a                   	pop    %edx
  2b:	68 b3 08 00 00       	push   $0x8b3
  30:	6a 01                	push   $0x1
  32:	e8 69 04 00 00       	call   4a0 <printf>
  sleep(1);
  37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  3e:	e8 90 03 00 00       	call   3d3 <sleep>
  
  pid = fork();
  43:	e8 f3 02 00 00       	call   33b <fork>
  if(pid < 0){
  48:	83 c4 10             	add    $0x10,%esp
  4b:	85 c0                	test   %eax,%eax
  4d:	78 4c                	js     9b <main+0x9b>
    printf(1, "TEST_7 FAIL: fork failed\n");
    exit();
  }
  
  if(pid == 0){
  4f:	75 40                	jne    91 <main+0x91>
    getrusage(&usage);
  51:	83 ec 0c             	sub    $0xc,%esp
  54:	8d 45 e8             	lea    -0x18(%ebp),%eax
  57:	50                   	push   %eax
  58:	e8 86 03 00 00       	call   3e3 <getrusage>
    
    if(usage.nvcsw != 0){
  5d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  60:	83 c4 10             	add    $0x10,%esp
  63:	85 c0                	test   %eax,%eax
  65:	75 5a                	jne    c1 <main+0xc1>
  ...
  6c:	75 40                	jne    ae <main+0xae>
      printf(1, "TEST_7 FAIL: child write_count=%d, expected 0\n", usage.write_count);
      exit();
    }
    
    if(usage.utime > 2 || usage.stime > 2){
  6e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  71:	8b 55 ec             	mov    -0x14(%ebp),%edx
  74:	83 f8 02             	cmp    $0x2,%eax
  77:	77 05                	ja     7e <main+0x7e>
  79:	83 fa 02             	cmp    $0x2,%edx
  7c:	76 56                	jbe    d4 <main+0xd4>
  ...
  wait();
  91:	e8 b5 02 00 00       	call   34b <wait>
  exit();
  96:	e8 a8 02 00 00       	call   343 <exit>
    printf(1, "TEST_7 FAIL: fork failed\n");
  9b:	50                   	push   %eax
  9c:	50                   	push   %eax
  9d:	68 c3 08 00 00       	push   $0x8c3
  a2:	6a 01                	push   $0x1
  a4:	e8 f7 03 00 00       	call   4a0 <printf>
    exit();
  a9:	e8 95 02 00 00       	call   343 <exit>
      printf(1, "TEST_7 FAIL: child write_count=%d, expected 0\n", usage.write_count);
  ae:	52                   	push   %edx
  af:	50                   	push   %eax
  b0:	68 1c 08 00 00       	push   $0x81c
  b5:	6a 01                	push   $0x1
  b7:	e8 e4 03 00 00       	call   4a0 <printf>
      exit();
  bc:	e8 82 02 00 00       	call   343 <exit>
      printf(1, "TEST_7 FAIL: child nvcsw=%d, expected 0\n", usage.nvcsw);
  c1:	51                   	push   %ecx
  c2:	50                   	push   %eax
  c3:	68 f0 07 00 00       	push   $0x7f0
  c8:	6a 01                	push   $0x1
  ca:	e8 d1 03 00 00       	call   4a0 <printf>
      exit();
  cf:	e8 6f 02 00 00       	call   343 <exit>
    printf(1, "TEST_7 PASS: child starts with fresh counters\n");
  d4:	50                   	push   %eax
  d5:	50                   	push   %eax
  d6:	68 84 08 00 00       	push   $0x884
  db:	6a 01                	push   $0x1
  dd:	e8 be 03 00 00       	call   4a0 <printf>
    exit();
  e2:	e8 5c 02 00 00       	call   343 <exit>
  e7:	66 90                	xchg   %ax,%ax
  e9:	66 90                	xchg   %ax,%ax
  eb:	66 90                	xchg   %ax,%ax
  ed:	66 90                	xchg   %ax,%ax
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 3c 09 00 00 	movzbl 0x93c(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 e4 08 00 00 	jmp    *0x8e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba dd 08 00 00       	mov    $0x8dd,%edx
        while(*s != 0){
 ...
 641:	a1 e4 0b 00 00       	mov    0xbe4,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d e4 0b 00 00    	mov    0xbe4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d e4 0b 00 00    	mov    0xbe4,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 e4 0b 00 00    	mov    0xbe4,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 e4 0b 00 00    	mov    %edx,0xbe4
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 e4 0b 00 00 e8 	movl   $0xbe8,0xbe4
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf e8 0b 00 00       	mov    $0xbe8,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 e8 0b 00 00 e8 	movl   $0xbe8,0xbe8
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 ec 0b 00 00 00 	movl   $0x0,0xbec
 7b2:	00 00 00 
    if(p->s.size >= nunits){
