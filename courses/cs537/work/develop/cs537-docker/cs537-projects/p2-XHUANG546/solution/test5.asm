...
main(void)
{
  ...
  33:	e8 8b 03 00 00       	call   3c3 <getrusage>
  ...
  42:	c7 45 b4 00 00 00 00 	movl   $0x0,-0x4c(%ebp)
{
  ...
  93:	50                   	push   %eax
  94:	e8 2a 03 00 00       	call   3c3 <getrusage>
  
  if(after.utime <= before.utime){
  99:	8b 55 d8             	mov    -0x28(%ebp),%edx
  9c:	8b 45 c8             	mov    -0x38(%ebp),%eax
  9f:	83 c4 10             	add    $0x10,%esp
  a2:	39 c2                	cmp    %eax,%edx
  a4:	77 13                	ja     b9 <main+0xb9>
    printf(1, "TEST_5 FAIL: utime did not increase (%d -> %d)\n",
  a6:	52                   	push   %edx
  a7:	50                   	push   %eax
  a8:	68 d0 07 00 00       	push   $0x7d0
  ad:	6a 01                	push   $0x1
  af:	e8 cc 03 00 00       	call   480 <printf>
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 2c 08 00 00 	jmp    *0x82c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 25 08 00 00       	mov    $0x825,%edx
        while(*s != 0){
