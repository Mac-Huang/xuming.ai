   ...
   e:	bb 0f 00 00 00       	mov    $0xf,%ebx
{
  ...
  3b:	6a 01                	push   $0x1
  3d:	e8 31 03 00 00       	call   373 <sleep>
  for(i = 0; i < num_sleeps; i++){
  42:	83 c4 10             	add    $0x10,%esp
  45:	83 eb 01             	sub    $0x1,%ebx
  48:	75 ee                	jne    38 <main+0x38>
  }
  
  getrusage(&after);
  4a:	83 ec 0c             	sub    $0xc,%esp
  4d:	8d 45 e8             	lea    -0x18(%ebp),%eax
  50:	50                   	push   %eax
  51:	e8 2d 03 00 00       	call   383 <getrusage>
  
  int diff = after.nvcsw - before.nvcsw;
  56:	8b 45 f0             	mov    -0x10(%ebp),%eax
  59:	2b 45 e0             	sub    -0x20(%ebp),%eax
  
  if(diff != num_sleeps){
  5c:	83 c4 10             	add    $0x10,%esp
  5f:	83 f8 0f             	cmp    $0xf,%eax
  62:	74 14                	je     78 <main+0x78>
    printf(1, "TEST_9 FAIL: Expected nvcsw +%d, got +%d\n", num_sleeps, diff);
  64:	50                   	push   %eax
  65:	6a 0f                	push   $0xf
  67:	68 9c 07 00 00       	push   $0x79c
  6c:	6a 01                	push   $0x1
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 54 08 00 00 	movzbl 0x854(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 fc 07 00 00 	jmp    *0x7fc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba f4 07 00 00       	mov    $0x7f4,%edx
        while(*s != 0){
 ...
 5e1:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 00 0b 00 00    	mov    %edx,0xb00
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 00 0b 00 00    	mov    %edx,0xb00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 00 0b 00 00    	mov    0xb00,%edx
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 737:	0b 00 00 
    base.s.size = 0;
 73a:	bf 04 0b 00 00       	mov    $0xb04,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 746:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 752:	00 00 00 
    if(p->s.size >= nunits){
