...
main(void)
{
  ...
  23:	e8 2b 03 00 00       	call   353 <getrusage>
  28:	83 c4 10             	add    $0x10,%esp
  2b:	85 c0                	test   %eax,%eax
  2d:	78 13                	js     42 <main+0x42>
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 08 08 00 00 	movzbl 0x808(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 b0 07 00 00 	jmp    *0x7b0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba a6 07 00 00       	mov    $0x7a6,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 b0 0a 00 00       	mov    0xab0,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 b0 0a 00 00    	mov    %edx,0xab0
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 b0 0a 00 00    	mov    %edx,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 b0 0a 00 00    	mov    %edx,0xab0
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 b0 0a 00 00 b4 	movl   $0xab4,0xab0
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf b4 0a 00 00       	mov    $0xab4,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 716:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 722:	00 00 00 
    if(p->s.size >= nunits){
