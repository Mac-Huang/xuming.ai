...
main(void)
{
   ...
   b:	89 e5                	mov    %esp,%ebp
   d:	51                   	push   %ecx
   e:	83 ec 3c             	sub    $0x3c,%esp
  struct rusage r1, r2, r3;
  
  printf(1, "TEST_11 START: Monotonicity test\n");
  11:	68 18 08 00 00       	push   $0x818
  16:	6a 01                	push   $0x1
  18:	e8 d3 04 00 00       	call   4f0 <printf>
  
  getrusage(&r1);
  1d:	8d 45 c8             	lea    -0x38(%ebp),%eax
  20:	89 04 24             	mov    %eax,(%esp)
  23:	e8 0b 04 00 00       	call   433 <getrusage>
  sleep(1);
  28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  2f:	e8 ef 03 00 00       	call   423 <sleep>
  printf(1, "X");
  34:	5a                   	pop    %edx
  35:	59                   	pop    %ecx
  36:	68 37 09 00 00       	push   $0x937
  3b:	6a 01                	push   $0x1
  3d:	e8 ae 04 00 00       	call   4f0 <printf>
  getrusage(&r2);
  42:	8d 45 d8             	lea    -0x28(%ebp),%eax
  45:	89 04 24             	mov    %eax,(%esp)
  48:	e8 e6 03 00 00       	call   433 <getrusage>
  sleep(1);
  4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  54:	e8 ca 03 00 00       	call   423 <sleep>
  printf(1, "Y");
  59:	58                   	pop    %eax
  5a:	5a                   	pop    %edx
  5b:	68 39 09 00 00       	push   $0x939
  60:	6a 01                	push   $0x1
  62:	e8 89 04 00 00       	call   4f0 <printf>
  getrusage(&r3);
  67:	8d 45 e8             	lea    -0x18(%ebp),%eax
  6a:	89 04 24             	mov    %eax,(%esp)
  6d:	e8 c1 03 00 00       	call   433 <getrusage>
  
  if(r2.utime < r1.utime || r3.utime < r2.utime){
  72:	8b 45 d8             	mov    -0x28(%ebp),%eax
  75:	8b 55 c8             	mov    -0x38(%ebp),%edx
  78:	83 c4 10             	add    $0x10,%esp
  7b:	39 d0                	cmp    %edx,%eax
  7d:	72 52                	jb     d1 <main+0xd1>
  7f:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  82:	77 4d                	ja     d1 <main+0xd1>
  ...
  84:	8b 45 dc             	mov    -0x24(%ebp),%eax
  87:	8b 55 cc             	mov    -0x34(%ebp),%edx
  8a:	8b 4d ec             	mov    -0x14(%ebp),%ecx
  8d:	39 d0                	cmp    %edx,%eax
  8f:	72 5c                	jb     ed <main+0xed>
  91:	39 c8                	cmp    %ecx,%eax
  93:	77 58                	ja     ed <main+0xed>
  ...
  95:	8b 45 e0             	mov    -0x20(%ebp),%eax
  98:	8b 55 d0             	mov    -0x30(%ebp),%edx
  9b:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  9e:	39 d0                	cmp    %edx,%eax
  a0:	72 65                	jb     107 <main+0x107>
  a2:	39 c8                	cmp    %ecx,%eax
  a4:	77 61                	ja     107 <main+0x107>
  ...
  ac:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  af:	39 d0                	cmp    %edx,%eax
  b1:	72 04                	jb     b7 <main+0xb7>
  b3:	39 c8                	cmp    %ecx,%eax
  b5:	76 6a                	jbe    121 <main+0x121>
    printf(1, "TEST_11 FAIL: write_count decreased (%d -> %d -> %d)\n",
  b7:	83 ec 0c             	sub    $0xc,%esp
  ba:	51                   	push   %ecx
  bb:	50                   	push   %eax
  bc:	52                   	push   %edx
  bd:	68 cc 08 00 00       	push   $0x8cc
  c2:	6a 01                	push   $0x1
  c4:	e8 27 04 00 00       	call   4f0 <printf>
           r1.write_count, r2.write_count, r3.write_count);
    exit();
  c9:	83 c4 20             	add    $0x20,%esp
  cc:	e8 c2 02 00 00       	call   393 <exit>
    printf(1, "TEST_11 FAIL: utime decreased (%d -> %d -> %d)\n", 
  d1:	83 ec 0c             	sub    $0xc,%esp
  d4:	ff 75 e8             	push   -0x18(%ebp)
  d7:	50                   	push   %eax
  d8:	52                   	push   %edx
  d9:	68 3c 08 00 00       	push   $0x83c
  de:	6a 01                	push   $0x1
  e0:	e8 0b 04 00 00       	call   4f0 <printf>
    exit();
  e5:	83 c4 20             	add    $0x20,%esp
  e8:	e8 a6 02 00 00       	call   393 <exit>
    printf(1, "TEST_11 FAIL: stime decreased (%d -> %d -> %d)\n",
  ed:	83 ec 0c             	sub    $0xc,%esp
  f0:	51                   	push   %ecx
  f1:	50                   	push   %eax
  f2:	52                   	push   %edx
  f3:	68 6c 08 00 00       	push   $0x86c
  f8:	6a 01                	push   $0x1
  fa:	e8 f1 03 00 00       	call   4f0 <printf>
    exit();
  ff:	83 c4 20             	add    $0x20,%esp
 102:	e8 8c 02 00 00       	call   393 <exit>
    printf(1, "TEST_11 FAIL: nvcsw decreased (%d -> %d -> %d)\n",
 107:	83 ec 0c             	sub    $0xc,%esp
 10a:	51                   	push   %ecx
 10b:	50                   	push   %eax
 10c:	52                   	push   %edx
 10d:	68 9c 08 00 00       	push   $0x89c
 112:	6a 01                	push   $0x1
 114:	e8 d7 03 00 00       	call   4f0 <printf>
    exit();
 ...
 121:	50                   	push   %eax
 122:	50                   	push   %eax
 123:	68 04 09 00 00       	push   $0x904
 128:	6a 01                	push   $0x1
 12a:	e8 c1 03 00 00       	call   4f0 <printf>
  exit();
 12f:	e8 5f 02 00 00       	call   393 <exit>
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 44 09 00 00 	jmp    *0x944(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 3b 09 00 00       	mov    $0x93b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 44 0c 00 00       	mov    0xc44,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 44 0c 00 00    	mov    %edx,0xc44
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 44 0c 00 00    	mov    %edx,0xc44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 44 0c 00 00    	mov    0xc44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 44 0c 00 00    	mov    0xc44,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 44 0c 00 00    	mov    0xc44,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 44 0c 00 00    	mov    %edx,0xc44
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 44 0c 00 00 48 	movl   $0xc48,0xc44
 7e7:	0c 00 00 
    base.s.size = 0;
 7ea:	bf 48 0c 00 00       	mov    $0xc48,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 48 0c 00 00 48 	movl   $0xc48,0xc48
 7f6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 4c 0c 00 00 00 	movl   $0x0,0xc4c
 802:	00 00 00 
    if(p->s.size >= nunits){
