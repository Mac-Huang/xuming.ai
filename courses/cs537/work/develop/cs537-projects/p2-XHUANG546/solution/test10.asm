...
_test10:     file format elf32-i386
...
main(void)
{
  ...
  13:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
  
  printf(1, "TEST_10 START: No context switch test\n");
  1a:	68 c8 07 00 00       	push   $0x7c8
  1f:	6a 01                	push   $0x1
  volatile long long dummy = 0;
  21:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
  printf(1, "TEST_10 START: No context switch test\n");
  28:	e8 73 04 00 00       	call   4a0 <printf>
  
  getrusage(&before);
  2d:	8d 45 c8             	lea    -0x38(%ebp),%eax
  30:	89 04 24             	mov    %eax,(%esp)
  33:	e8 ab 03 00 00       	call   3e3 <getrusage>

  for(i = 0; i < 100000; i++){
  38:	c7 45 b0 00 00 00 00 	movl   $0x0,-0x50(%ebp)
  getrusage(&before);
  3f:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < 100000; i++){
  42:	c7 45 b4 00 00 00 00 	movl   $0x0,-0x4c(%ebp)
{
  ...
  4f:	90                   	nop
    for(j = 0; j < 10000; j++){
      dummy += i*j;
  50:	8b 45 c0             	mov    -0x40(%ebp),%eax
  53:	8b 55 c4             	mov    -0x3c(%ebp),%edx
  56:	01 f0                	add    %esi,%eax
  58:	11 fa                	adc    %edi,%edx
    for(j = 0; j < 10000; j++){
  5a:	83 c1 01             	add    $0x1,%ecx
      dummy += i*j;
  5d:	89 45 c0             	mov    %eax,-0x40(%ebp)
    for(j = 0; j < 10000; j++){
  60:	03 75 b0             	add    -0x50(%ebp),%esi
      dummy += i*j;
  63:	89 55 c4             	mov    %edx,-0x3c(%ebp)
    for(j = 0; j < 10000; j++){
  66:	13 7d b4             	adc    -0x4c(%ebp),%edi
  69:	81 f9 10 27 00 00    	cmp    $0x2710,%ecx
  6f:	75 df                	jne    50 <main+0x50>
  for(i = 0; i < 100000; i++){
  71:	83 45 b0 01          	addl   $0x1,-0x50(%ebp)
  75:	8b 75 b0             	mov    -0x50(%ebp),%esi
  78:	83 55 b4 00          	adcl   $0x0,-0x4c(%ebp)
  7c:	8b 7d b4             	mov    -0x4c(%ebp),%edi
  7f:	89 f2                	mov    %esi,%edx
  81:	81 f2 a0 86 01 00    	xor    $0x186a0,%edx
  87:	89 f8                	mov    %edi,%eax
  89:	09 d0                	or     %edx,%eax
  8b:	75 bc                	jne    49 <main+0x49>
    }
  }
  
  getrusage(&after);
  8d:	83 ec 0c             	sub    $0xc,%esp
  90:	8d 45 d8             	lea    -0x28(%ebp),%eax
  93:	50                   	push   %eax
  94:	e8 4a 03 00 00       	call   3e3 <getrusage>
  ...
  d3:	50                   	push   %eax
  d4:	50                   	push   %eax
  d5:	68 98 08 00 00       	push   $0x898
  da:	6a 01                	push   $0x1
  dc:	e8 bf 03 00 00       	call   4a0 <printf>
  exit();
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 24 09 00 00 	movzbl 0x924(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 cc 08 00 00 	jmp    *0x8cc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba c3 08 00 00       	mov    $0x8c3,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 d4 0b 00 00       	mov    0xbd4,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 d4 0b 00 00    	mov    %edx,0xbd4
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 d4 0b 00 00    	mov    %edx,0xbd4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d d4 0b 00 00    	mov    0xbd4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d d4 0b 00 00    	mov    0xbd4,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 d4 0b 00 00    	mov    0xbd4,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 d4 0b 00 00    	mov    %edx,0xbd4
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 d4 0b 00 00 d8 	movl   $0xbd8,0xbd4
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf d8 0b 00 00       	mov    $0xbd8,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 d8 0b 00 00 d8 	movl   $0xbd8,0xbd8
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 dc 0b 00 00 00 	movl   $0x0,0xbdc
 7b2:	00 00 00 
    if(p->s.size >= nunits){
