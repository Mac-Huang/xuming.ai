// Project dates record first publication on this site, from version history.
const projects = [
  {
    ...
    "links": [
      {
        "label": "PR Branch",
        "url": "https://github.com/Mac-Huang/npu_compiler/tree/codex/sorting-cache-pr"
      },
      {
        "label": "Upstream Compiler",
