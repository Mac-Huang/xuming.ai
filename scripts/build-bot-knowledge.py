...
add('football','Flag football','Xuming captained the USST Earthmoving Vehicles flag football team, which won the 2023 NFL FLAG national championship.','blog/posts/nfl-flag-football-championship.html',aliases=['football','sports','hobbies','champion','championship'],authoritative=True)
