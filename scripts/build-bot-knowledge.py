...
for p in data['publications']:
 aliases={'wuklab':['wuklab','yiying','zhang','ucsd','uc san diego','edge ai','npu'], 'linuxguard-2025':['linuxguard','remzi','arpaci','dusseau','vinay','banakar','adsl','security'], 'os-inference':['michael swift','swift','filesystem','honors project'], 'cash':['cash','xing hu','scheduling','usst research']}[p['id']]
