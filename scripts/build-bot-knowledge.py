...
add('bio','Current role and research interests','Xuming Huang is a Computer Sciences undergraduate at the University of Wisconsin–Madison, with graduation expected in May 2027. His interests are systems for AI, edge inference, operating systems, and AI compilers. His current research at WukLab, UC San Diego, focuses on NPU compilers and runtimes with Professor Yiying Zhang.','index.html',aliases=['who are you','who is xuming','about you','introduce yourself','current research','research focus','research interests'],authoritative=True)
add('research-overview','Research experience','Xuming’s current research at WukLab, UC San Diego, focuses on efficient NPU compilers and inference runtimes. His other research includes LinuxGuard at ADSL, UW–Madison, using LLMs and compiler feedback to build Linux-kernel bug detectors; an honors project with Michael Swift measuring how filesystem activity affects AI inference; and CASH at USST, studying workload-aware CPU/GPU scheduling.','research.html',aliases=['research','research experience','research background','research projects','past research'],authoritative=True)
...
add('football','Flag football','Xuming captained the USST Earthmoving Vehicles flag football team, which won the 2023 NFL FLAG national championship.','blog/posts/nfl-flag-football-championship.html',aliases=['football','flag football','football experience','football background','experience playing football','play football','football team','sports','sports experience','hobbies','champion','championship'],authoritative=True)
